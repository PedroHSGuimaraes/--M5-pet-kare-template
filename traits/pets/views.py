...
class PetView(APIView, PageNumberPagination):
    ...
    def post(self, request):
        ...
        for trait in trait_list:
            trait_obj, _ = Trait.objects.get_or_create(name__iexact=trait["name"], defaults=trait)
...
class PetDetailView(APIView, PageNumberPagination):
    ...
    def patch(self, request, pet_id):
        ...
        if trait_list:
            new_traits = [Trait.objects.get_or_create(name__iexact=trait["name"], defaults=trait)[0] for trait in trait_list]
